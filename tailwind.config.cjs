...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        display: ['5rem', { lineHeight: '1', letterSpacing: '0', fontWeight: '800' }],
        h1: ['3.5rem', { lineHeight: '1.1', letterSpacing: '0', fontWeight: '700' }],
        h2: ['2.5rem', { lineHeight: '1.15', letterSpacing: '0', fontWeight: '700' }],
        h3: ['1.75rem', { lineHeight: '1.2', letterSpacing: '0', fontWeight: '600' }],
